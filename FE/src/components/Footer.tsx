      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={2} alignItems="center" sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} sm={6} sx={{ display: 'flex', justifyContent: { xs: 'flex-start', sm: 'flex-end' } }}>
            <Box component="img" src="https://www.manwah.com.vn/images/appstore.png" alt="App Store" sx={{ height: 40, mr: 2 }} />
            <Box component="img" src="https://www.manwah.com.vn/images/googleplay.png" alt="Google Play" sx={{ height: 40 }} />
          </Grid>
        </Grid>
